...
const featureSections = [
  {
    ...
    desc: "超輕量、道路合法、強悍無比。7.2 kWh 電池搭配 80 HP 馬達與瞬間扭力響應，混合都市續航約 117 公里。全新 3.3 kW 便攜式充電器可放入背包，隨處充電。",
...
const specs = {
  動力系統: [
    ...
    { label: "後輪扭力", value: "914 Nm" },
    { label: "電池容量", value: "7.2 kWh, 420V" },
    { label: "充電時間", value: "約 2 小時 (240V)" },
    { label: "充電器", value: "3.3 kW 便攜式充電器" },
    { label: "續航 (混合都市)", value: "約 117 km" },
  ],
  底盤懸吊: [
    { label: "車架", value: "高強度鋼管車架" },
    { label: "前叉", value: "KYB 48mm 閉合式彈簧前叉, 290mm 行程" },
    { label: "前煞車", value: "Brembo 四活塞輻射卡鉗, 320mm 碟盤" },
    { label: "後煞車", value: "單活塞卡鉗, 220mm 碟盤" },
    { label: "前輪胎", value: "120/70-17" },
    { label: "後輪胎", value: "140/70-17" },
  ],
  車輛資訊: [
    { label: "整備重量", value: "124 kg" },
    { label: "座高", value: "935 mm" },
    { label: "軸距", value: "1471 mm" },
    { label: "前傾角", value: "26.1°" },
    { label: "道路合法", value: "✅" },
    { label: "LED 燈具", value: "✅" },
    { label: "方向燈 / 後照鏡", value: "✅" },
  ],
