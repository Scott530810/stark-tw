...
const heroImages = [
  ...
  "https://assets.starkfuture.com/frontend-assets/mx1.2/hero_02_desktop.webp",
  "https://assets.starkfuture.com/frontend-assets/mx1.2/hero_03_desktop.webp",
  "https://assets.starkfuture.com/frontend-assets/mx1.2/hero_04_desktop.webp",
  "https://assets.starkfuture.com/frontend-assets/mx1.2/hero_05_desktop.webp",
];
...
const featureSections = [
  {
    title: "為越野而生",
    subtitle: "Born for Motocross",
    desc: "VARG MX 1.2 是全球最強大的電動越野車。80 HP 的瞬間扭力輸出，搭配 978 Nm 後輪扭力，加速性能超越任何 450cc 四行程引擎越野車。",
    image: "https://assets.starkfuture.com/frontend-assets/mx1.2/carousel_01_slide_01_desktop.webp",
  },
  {
    title: "極致輕量",
    subtitle: "118 kg — Lighter Than a 450",
    desc: "整備重量僅 118 kg，比絕大多數 450cc 越野車更輕。大幅降低的旋轉質量，搭配全新升級的高強度鋼管車架，提供卓越的操控性與舒適性。",
    image: "https://assets.starkfuture.com/frontend-assets/mx1.2/carousel_01_slide_02_desktop.webp",
  },
  {
    title: "自訂一切",
    subtitle: "Your Bike, Your Rules",
    desc: "10 到 80 HP 可調動力、多種動力曲線模式，透過 App 即可調整。無論是練習、訓練還是比賽，都能找到最適合的設定。",
    image: "https://assets.starkfuture.com/frontend-assets/mx1.2/carousel_01_slide_03_desktop.webp",
  },
];
...
const specs = {
  動力系統: [
    ...
    { label: "後輪扭力", value: "978 Nm" },
    { label: "電池容量", value: "7.2 kWh, 420V" },
    { label: "充電時間", value: "約 2 小時 (240V) / 3.5 小時 (120V)" },
    { label: "充電器", value: "3.3 kW, 16A, 120/240V" },
    { label: "騎乘時間", value: "最長約 6 小時" },
  ],
  底盤懸吊: [
    { label: "車架", value: "高強度鋼管車架" },
    { label: "前叉", value: "KYB 48mm 閉合式彈簧前叉" },
    { label: "前叉調整", value: "壓縮/回彈可調" },
    { label: "前叉行程", value: "310 mm" },
    { label: "後避震行程", value: "303 mm" },
    { label: "前煞車", value: "雙活塞卡鉗, 260mm Galfer 碟盤" },
    { label: "後煞車碟", value: "220 mm" },
    { label: "前輪胎", value: "80/100-21" },
    { label: "後輪胎", value: "110/90-19" },
  ],
  車輛資訊: [
    { label: "整備重量", value: "118 kg" },
    { label: "座高", value: "960 mm" },
    { label: "軸距", value: "1487 mm" },
    { label: "前傾角", value: "27.3°" },
    { label: "用途", value: "Off-road / 越野競技" },
  ],
};

const galleryImages = [
  "https://assets.starkfuture.com/frontend-assets/mx1.2/carousel_02_slide_01_desktop.webp",
  "https://assets.starkfuture.com/frontend-assets/mx1.2/carousel_02_slide_02_desktop.webp",
  "https://assets.starkfuture.com/frontend-assets/mx1.2/carousel_02_slide_03_desktop.webp",
  "https://assets.starkfuture.com/frontend-assets/mx1.2/carousel_03_slide_01_desktop.webp",
  "https://assets.starkfuture.com/frontend-assets/mx1.2/carousel_03_slide_02_desktop.webp",
  "https://assets.starkfuture.com/frontend-assets/mx1.2/carousel_03_slide_03_desktop.webp",
];
...
export default function VargMXPage() {
  ...
  return (
    <>
      {/* Hero Carousel */}
      <ImageCarousel images={heroImages} alt="Stark VARG MX 1.2" interval={5000}>
          ...
          <div className="max-w-7xl mx-auto w-full">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div>
                ...
                <h1 className="text-5xl md:text-8xl font-bold tracking-tight leading-none">VARG MX 1.2</h1>
                <p className="text-lg md:text-xl text-white/60 mt-3 font-light italic">
                  The fastest electric motocross bike in the world
                </p>
              </div>
              <Link
                href="/contact"
      ...
      <section className="py-24 md:py-32 px-6 bg-[#111]">
        <AnimatedSection className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-8">純越野競技車款</h2>
          <p className="text-white/50 text-lg md:text-xl leading-relaxed">
            Experience the Stark VARG MX 1.2, the ultimate electric motocross bike.
            Lightweight and agile, with customizable power (10-80 HP), emission-free performance,
            and low maintenance. Built for the track, engineered for victory.
          </p>
        </AnimatedSection>
      </section>
      ...
      <section className="relative h-screen">
        <video
          ...
          poster="https://assets.starkfuture.com/frontend-assets/mx1.2/hero_01_desktop.webp"
        >
          <source src="https://assets.starkfuture.com/frontend-assets/mx1.2/crawl_mode_video_loop_mx1.2_desktop.mp4" type="video/mp4" />
        </video>
      </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {["01", "02", "03", "04"].map((n) => (
                <div key={n} className="relative aspect-square rounded-2xl overflow-hidden bg-[#1c1c1e]">
                  <Image
                    src={`https://assets.starkfuture.com/frontend-assets/mx1.2/product_carousel_${activeColor}_${n}_desktop.webp`}
                    alt={`VARG MX ${activeColor} view ${n}`}
                    fill
      ...
      <section className="relative py-32 md:py-48 px-6">
        <div className="absolute inset-0">
          <Image
            src="https://assets.starkfuture.com/frontend-assets/mx1.2/hero_05_desktop.webp"
            alt="VARG MX"
            fill
        ...
        <AnimatedSection className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-bold mb-6">對 VARG MX 有興趣？</h2>
