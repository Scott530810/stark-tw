...
const featureSections = [
  {
    ...
    desc: "VARG MX 1.2 是全球最強大的電動越野車。80 HP 的瞬間扭力輸出，搭配 938 Nm 後輪扭力，加速性能超越任何 450cc 四行程引擎越野車。",
    image: "https://assets.starkfuture.com/frontend-assets/mx1.2/carousel_01_slide_01_desktop.webp",
  },
  {
    title: "極致輕量",
    subtitle: "110 kg — Lighter Than a 450",
    desc: "整備重量僅 110 kg，比絕大多數 450cc 越野車更輕。更低的重心、更精準的操控，讓你在賽道上擁有絕對優勢。",
